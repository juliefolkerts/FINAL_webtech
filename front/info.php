...
?>
  ...
  <h1 class="info-title">The meaning of every colour</h1>
  ...
  <section class="info-section">
    <div class="info-row">
      <div class="image">
        <img src="images/info_image3.jpg" alt="Responsive design illustration">
      </div>
      <div class="text">
  ...
  <section class="info-section">
    <div class="info-row">
      <div class="image">
        <img src="images/darkpurplegroupflowers.jpg" alt="Design concept">
      </div>
      <div class="text">
  ...
  <section class="info-section">
    <div class="info-row">
      <div class="image">
        <img src="images/orangeflower.jpg" alt="Code structure example">
      </div>
      <div class="text">
  ...
  <section class="info-section">
    <div class="info-row">
      <div class="image">
        <img src="images/redflower3.jpg" alt="Design concept">
      </div>
      <div class="text">
        <h2>Red flowers</h2>
  ...
  <section class="info-section">
    <div class="info-row">
      <div class="image">
        <img src="images/lilacflower.png" alt="Code structure example">
      </div>
      <div class="text">
        <h2>Lilac Flowers</h2>
